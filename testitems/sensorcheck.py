...
def main(parser):
    ...
    targetMax = [500,500,500,500,500,1.9,5000,35,10,10,10,10,1.2,1.45,2.6,3.4,1200]
    targetMin = [  0,  0,  0,  0,  0,1.7,   0, 5, 0, 0, 0, 0,1.0,1.25,2.4,3.2, 900]
    ...
    for ch in range(17):
        ...
        value = 0
        if targetMin[ch] <= output <= targetMax[ch]:
            value = 1
